...
public final class ServiceUtils {
    ...
    public static Set getAllRunningServices() {
        ActivityManager am = (ActivityManager) AppConfig.INSTANCE.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(@NonNull final Class<?> cls) {
        Intent intent = new Intent(AppConfig.INSTANCE.getApp(), cls);
        AppConfig.INSTANCE.getApp().startService(intent);
    }
    ...
    public static boolean stopService(@NonNull final Class<?> cls) {
        Intent intent = new Intent(AppConfig.INSTANCE.getApp(), cls);
        return AppConfig.INSTANCE.getApp().stopService(intent);
    }
    ...
    public static void bindService(@NonNull final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(AppConfig.INSTANCE.getApp(), cls);
        AppConfig.INSTANCE.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(@NonNull final ServiceConnection conn) {
        AppConfig.INSTANCE.getApp().unbindService(conn);
    }
