...
public class UrlInterceptor implements Interceptor {
    ...
    private Map<String, HttpUrl> urlBucket = RetrofitFactory.INSTANCE.getUrlMap();
    ...
    private HttpUrl parseHeaderHttpUrl(HttpUrl headerHttpUrl, HttpUrl oldHttpUrl) {
        ...
        if (headerHttpUrl != null) {
            ...
            AppConfig.INSTANCE.log("-----", "pageSize = " + pathSize + ", old http url is " + oldHttpUrl + ", new http url is " + newHttpUrl);
            return newHttpUrl;
        }
